							...
							<td class="text-center">
								...
								<div class="dropdown-menu" style="">
									...
									<?php if ($_SESSION['login_type'] == 0) : ?>
										...
										<?php endif; ?>
									<?php endif; ?>
									<a class="dropdown-item view_progress" onClick="view_progress(this)" name="<?php echo ucwords($row['task']) ?>" id="<?php echo $row['id'] ?>" data-pid='<?php echo $row['pid'] ?>' data-tid='<?php echo $row['id'] ?>' data-task='<?php echo ucwords($row['task']) ?>' href="javascript:void(0)">Ver Progreso</a>
								</div>
							</td>
						</tr>
					<?php endwhile; ?>
